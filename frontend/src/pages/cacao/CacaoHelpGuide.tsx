...
const STEPS = [
  ...
  {
    num: 5,
    title: 'Kárdex (integrado en Lotes)',
    icon: '📊',
    color: '#e53e3e',
    description: 'El kárdex está integrado en la sección de Lotes. Haga clic en "Ver Kardex" de cualquier lote para ver su historial de movimientos de entrada y salida.',
    details: [
      { label: 'Método', desc: 'Costeo promedio ponderado. Cada entrada recalcula el costo promedio del lote.' },
      { label: 'Entradas', desc: 'Se registran automáticamente al crear una recepción.' },
      { label: 'Salidas', desc: 'Se registran automáticamente al crear un embarque. Descuenta del saldo.' },
      { label: 'Cómo acceder', desc: 'Vaya a Lotes → haga clic en "Ver Kardex" → vea el detalle con entradas, salidas y saldos. Puede descargar en PDF.' },
    ],
    path: '/cacao/lots',
    tip: 'El kárdex siempre está en kilogramos. Puede descargar el reporte en PDF desde el detalle del lote.',
  },
  {
    num: 6,
