...
- **`personal/`** — HR: recruitment pipeline (Google Drive sync for candidate docs — no Kanban board, that was removed 2026-09-17 as unused), certifications with expiry alerts, compliance checklists per employee (cédula), job positions.
